	...
	class Commit {
		public:
			...
			std::ostream& Trade(std::ostream& out) const noexcept {
				...
				out << "\t\twhile (++index < next) {" << std::endl;
				out << "\t\t\tout << \",\" << std::endl << \"\\t\\t\\\"\" << Items::item[Trade::in::item[index]].name << \"\\\": \" << Trade::in::quantity[index];" << std::endl;
				out << "\t\t}" << std::endl;
				...
				out << "\t\twhile (++index < next) {" << std::endl;
				out << "\t\t\tout << \",\" << std::endl << \"\\t\\t\\\"\" << Items::item[Trade::out::item[index]].name << \"\\\": \" << Trade::out::quantity[index];" << std::endl;
				out << "\t\t}" << std::endl;
				out << "\t\tout << std::endl << \"\\t}\" << std::endl;" << std::endl;
				out << std::endl;
				out << "\t\tout << \"}\" << std::endl;" << std::endl;
